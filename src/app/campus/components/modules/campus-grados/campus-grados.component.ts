...
@Component({
  ...
  standalone: true,
  imports: [RouterModule, CardComponent, NgxPaginationModule, CommonModule,PaginationComponent],
...
export class CampusGradosComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    const storedGrado = localStorage.getItem('grado'); // Obtener grado almacenado
    ...
    if (usuarioId) {
      try {
        ...
        // Preseleccionar el grado si está almacenado
        if (storedGrado && this.grados.includes(`${storedGrado}°`)) {
